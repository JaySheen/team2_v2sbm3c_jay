...
<jsp:include page="../menu/top.jsp" flush='false' />
 ...
 <A href="../brpost/list_by_notice_no_search_paging.do" class='title_link'> 🍞공지사항🍞  > 글 등록</DIV>
</DIV>
...
<DIV class='notice_body'>
  ...
  <FORM name='frm' method='POST' action='./create.do' class="form-horizontal"
    ...
    <div class="form-group">
       ...
       <div class="col-md-10">
         <input type='text' name='notice_name' value='제목' required="required" 
    ...
    <div class="form-group">
       ...
       <div class="col-md-10">
         <textarea name='notice_post' required="required" class="form-control" rows="12" style='width: 100%;'>내용</textarea>
       </div>
    </div>
    <div class="form-group">
       <label class="control-label col-md-2">검색어</label>
       <div class="col-md-10">
         <input type='text' name='notice_word' value='#검색어' required="required" 
