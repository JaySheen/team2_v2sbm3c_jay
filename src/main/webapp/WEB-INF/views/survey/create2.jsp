...
<jsp:include page="../menu/top.jsp" flush='false' />
  ...
  9개 빵에 평가를 해주시면 빵파고가 당신에게 가장 잘 맞는 빵을 추천해줄거예요🤩<br>(2/9)
  </div>
  <FORM name='frm' method='POST' action='./create2.do' class="form-horizontal"
             enctype="multipart/form-data">
    <input type="hidden" name="memberno" value="${memberno}">
    <input type="hidden" name="breadno" value="14">
    ...
    <div class="form-group">
        <TABLE style='margin: 0px auto;'>
            ...
            <TR>
                <TD class='td_image'>
                    <img id='img1' src="/survey/images/2.1 크루아상2.jpg" style='float:left; width: 150px'><br>
                    2번 "크루아상"
                </TD>
                <TD class='td_radio'>
